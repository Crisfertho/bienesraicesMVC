 <main class="contenedor seccion">
        ...
        <div class="contenido-nosotros">
            <div class="imagen">
              <picture>
                ...
                <img loading="lazy" src="build/img/nosotros.jpg" alt="Imagen Sobre Nosotros" class="roundimg">
              </picture>
            </div>
            ...
            <div class="texto-nosotros">
              ...
              <p>Proin consequat viverra sapien, malesuada tempor tortor feugiat vitae. In dictum felis et nunc 
                ...
                Vivamus accumsan maximus est, eu mollis mi. 
              </p>
              <p>Aliquam lectus magna, luctus vel gravida nec, iaculis ut augue. Praesent ac enim lorem. Quisque ac 
                ...
                fermentum sed turpis nec, hendrerit dapibus ante. Cras mattis laoreet nibh, quis tincidunt odio fermentum
                 vel. Nulla facilisi.
                </p>
            </div>
        </div>
    ...
    <section class="contenedor seccion">
        ...
        <a href="/index.php" class="boton boton_verde">VOLVER
         <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrow-back-up-double" width="28" height="28" viewBox="0 -7 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
