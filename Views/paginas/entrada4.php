<main class="contenedor seccion contenido-centrado">
    <a href="/blog" class="boton boton_verde">VOLVER</a>
        <h1>Casa con un lago increible</h1>

        <picture>
            <source srcset="build/img/ia4.webp" type="image/webp">
            <source srcset="build/img/ia4.jpg" type="image/jpeg">
            <img loading="lazy" src="build/img/ia4.jpg" alt="Imagen de la propiedad">
        </picture>
        ...
        <div class="resumen-propiedad">
            ...
            <p>Aliquam lectus magna, luctus vel gravida nec, iaculis ut augue. Praesent ac enim lorem. Quisque ac 
                dignissim sem, non condimentum orci. Morbi a iaculis neque, ac euismod felis. Fusce augue quam, fermentum 
                sed turpis nec, hendrerit dapibus ante. Cras mattis laoreet nibh, quis tincidunt odio fermentum vel. 
                Nulla facilisi.
            </p>
        </div>
</main>